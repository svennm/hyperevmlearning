...
contract PutHandler is Test {
    EverlastingMarket public put; MockUSDC public usdc; MockOracle public oracle;
    address[] public actors;
    uint256 public marksPosted;
    constructor(EverlastingMarket _p, MockUSDC _u, MockOracle _o, address[] memory _a){ put=_p; usdc=_u; oracle=_o; actors=_a; }
...
contract PutInvariantTest is Test {
    EverlastingMarket put; MockUSDC usdc; MockOracle oracle; PutHandler h;
    address[] actors;
    function setUp() public {
        ...
        put = new EverlastingMarket(usdc, oracle, EverlastingMarket.Side.PUT, 48e18, 48e18, predicted); // nonce N; lp = this
